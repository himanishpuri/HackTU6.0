const NewPrize = () => {
	return (
	  <>
		<div className="justify-center flex flex-wrap md:space-y-0 space-y-5">
		  <h1 className="text-[8vw] text-[#D1FAE5] mt-[20vw] md:mt-[120px] font-extrabold tracking-normal absolute">
			PRIZES
		  </h1>
		  <h1 className="text-[15vw] text-[#D1FAE5] opacity-10 font-extrabold tracking-normal">
			PRIZES
		  </h1>
		</div>
		<div className="h-auto md:h-screen w-full flex flex-col md:flex-row bg-[#0F203E] justify-center items-center p-3 md:p-9">
